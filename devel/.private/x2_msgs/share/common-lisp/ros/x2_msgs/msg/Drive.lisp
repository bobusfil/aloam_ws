...
(cl:defmethod cl:initialize-instance :after ((m <Drive>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Drive)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name x2_msgs-msg:<Drive> is deprecated: use x2_msgs-msg:Drive instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <Drive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:mode-val is deprecated.  Use x2_msgs-msg:mode instead.")
  (mode m))
