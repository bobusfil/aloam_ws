...
(cl:defmethod cl:initialize-instance :after ((m <DriveFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name x2_msgs-msg:<DriveFeedback> is deprecated: use x2_msgs-msg:DriveFeedback instead.")))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <DriveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:current-val is deprecated.  Use x2_msgs-msg:current instead.")
  (current m))

(cl:ensure-generic-function 'duty_cycle-val :lambda-list '(m))
(cl:defmethod duty_cycle-val ((m <DriveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:duty_cycle-val is deprecated.  Use x2_msgs-msg:duty_cycle instead.")
  (duty_cycle m))

(cl:ensure-generic-function 'bridge_temperature-val :lambda-list '(m))
(cl:defmethod bridge_temperature-val ((m <DriveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:bridge_temperature-val is deprecated.  Use x2_msgs-msg:bridge_temperature instead.")
...
(cl:defmethod motor_temperature-val ((m <DriveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:motor_temperature-val is deprecated.  Use x2_msgs-msg:motor_temperature instead.")
  (motor_temperature m))

(cl:ensure-generic-function 'measured_velocity-val :lambda-list '(m))
(cl:defmethod measured_velocity-val ((m <DriveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:measured_velocity-val is deprecated.  Use x2_msgs-msg:measured_velocity instead.")
  (measured_velocity m))

(cl:ensure-generic-function 'measured_travel-val :lambda-list '(m))
(cl:defmethod measured_travel-val ((m <DriveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:measured_travel-val is deprecated.  Use x2_msgs-msg:measured_travel instead.")
  (measured_travel m))

(cl:ensure-generic-function 'driver_fault-val :lambda-list '(m))
(cl:defmethod driver_fault-val ((m <DriveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:driver_fault-val is deprecated.  Use x2_msgs-msg:driver_fault instead.")
  (driver_fault m))
