...
(cl:defmethod cl:initialize-instance :after ((m <SetPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name subt_msgs-srv:<SetPose-request> is deprecated: use subt_msgs-srv:SetPose-request instead.")))

(cl:ensure-generic-function 'performer-val :lambda-list '(m))
(cl:defmethod performer-val ((m <SetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader subt_msgs-srv:performer-val is deprecated.  Use subt_msgs-srv:performer instead.")
  (performer m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SetPose-request>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'performer))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'performer))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SetPose-request>) istream)
  "Deserializes a message object of type '<SetPose-request>"
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'performer) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'performer) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetPose-request>)))
  ...
  "e75fa6b5606a256e6021356eef2fa1e5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetPose-request)))
  "Returns md5sum for a message object of type 'SetPose-request"
  "e75fa6b5606a256e6021356eef2fa1e5")
...
(cl:defmethod cl:initialize-instance :after ((m <SetPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name subt_msgs-srv:<SetPose-response> is deprecated: use subt_msgs-srv:SetPose-response instead.")))
