...
class SetPoseRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('performer')) {
        this.performer = initObj.performer
      }
      else {
        this.performer = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [performer]
    bufferOffset = _serializer.string(obj.performer, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [performer]
    data.performer = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += object.performer.length;
    return length + 60;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.performer !== undefined) {
      resolved.performer = msg.performer;
    }
    else {
      resolved.performer = ''
    }
...
module.exports = {
  ...
  md5sum() { return 'e75fa6b5606a256e6021356eef2fa1e5'; },
  datatype() { return 'subt_msgs/SetPose'; }
};
