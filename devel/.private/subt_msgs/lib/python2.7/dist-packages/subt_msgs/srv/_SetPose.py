...
"""autogenerated by genpy from subt_msgs/SetPoseRequest.msg. Do not edit."""
import codecs
import sys
...
class SetPoseRequest(genpy.Message):
  _md5sum = "10fe238e24facfc21b079d99e28aea16"
  _type = "subt_msgs/SetPoseRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string performer
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.performer = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.performer = str[start:end]
      _x = self
      start = end
      end += 56
...
def _get_struct_7d():
    ...
    return _struct_7d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from subt_msgs/SetPoseResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetPoseResponse(genpy.Message):
  ...
  _type = "subt_msgs/SetPoseResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class SetPose(object):
  _type          = 'subt_msgs/SetPose'
  _md5sum = 'e75fa6b5606a256e6021356eef2fa1e5'
